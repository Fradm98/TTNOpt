...
def plot_final_vs_g(
    ...
    energies = {chi: get_chi_energies_from_couplings(folder, chi, g_raw_values, precision=precision) for chi in chis}
    entropies = {chi: get_chi_entropies_from_couplings(folder, chi, g_raw_values, precision=precision) for chi in chis}
